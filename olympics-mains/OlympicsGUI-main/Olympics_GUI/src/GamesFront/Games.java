...
public class Games extends javax.swing.JFrame {
    ...
    private void btnResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResultsActionPerformed
        ...
        switch(elijio){
            case 0 :                
                JOptionPane.showMessageDialog(null, "El ganador es...\n ˗ˏˋ Nadador " + (indicedelganador(puntajesfinales1, recursivabuscaganador(puntajesfinales1, 0, puntajesfinales1.get(0)))+1)+"´ˎ˗  \n" + " con " 
                        + df.format(recursivabuscaganador(puntajesfinales1, 0, puntajesfinales1.get(0)))+ " segundos");
            ...
            case 1:
                ...
                HashMap < Float, Integer> Indice2 = new HashMap<>();
                    for (int i = 0; i < puntajesfinales2.size(); i++) {
                        Indice2.put(puntajesfinales2.get(i), i+1);
                    }
                ...
                int indiceT = Indice2.get(tercerLugar);    
                 ...
                 JOptionPane.showMessageDialog(null, "El primer lugar es para... \n ˗ˏˋ Nadador " + indiceP + "´ˎ˗" + "\n con " + df.format(primerLugar) + " segundos" +
                                   "\n\nEl segundo lugar es para... \n ˗ˏˋ Nadador " + indiceS + "´ˎ˗" + "\n con " + df.format(segundoLugar) + " segundos" +
                                   "\n\nEl tercer lugar es para... \n ˗ˏˋ Nadador " + indiceT + "´ˎ˗" + "\n con " + df.format(tercerLugar)+ " segundos");
            ...
            case 2:  
                ...
                HashMap < Float, Integer> Indice3 = new HashMap<>();
                    for (int i = 0; i < puntajesfinales3.size(); i++) {
                        Indice3.put(puntajesfinales3.get(i), i+1);
                    }
                ...
                JOptionPane.showMessageDialog(null, "El primer lugar es para... \n ˗ˏˋ Nadador " + indiceP1 + "´ˎ˗" + "\n con " + df.format(primerLugar1) + " segundos" +
                                   "\n\nEl segundo lugar es para... \n ˗ˏˋ Nadador " + indiceS1 + "´ˎ˗" + "\n con " + df.format(segundoLugar1) + " segundos" +
                                   "\n\nEl tercer lugar es para... \n ˗ˏˋ Nadador " + indiceT1 + "´ˎ˗" + "\n con " + df.format(tercerLugar1)+ " segundos");
            ...
            case 3:  
                HashMap < Float, Integer> Indice4 = new HashMap<>();
                    for (int i = 0; i < puntajesfinales4.size(); i++) {
                        Indice4.put(puntajesfinales4.get(i), i+1);
                    }
                ...
                JOptionPane.showMessageDialog(null, "El primer lugar es para... \n ˗ˏˋ Nadador " + indiceP2 + "´ˎ˗" + "\n con " + df.format(primerLugar2) + " segundos" +
                                   "\n\nEl segundo lugar es para... \n ˗ˏˋ Nadador " + indiceS2 + "´ˎ˗" + "\n con " + df.format(segundoLugar2) + " segundos" +
                                   "\n\nEl tercer lugar es para... \n ˗ˏˋ Nadador " + indiceT2 + "´ˎ˗" + "\n con " + df.format(tercerLugar2)+ " segundos");

                break;
                      
        }
        JOptionPane.showMessageDialog(null, "Presione 'Start' para ver otra competencia o presione 'Finish' para terminar con la simulacion");
